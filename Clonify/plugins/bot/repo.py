...
┠ ◆ **ʀᴇʟᴇᴀsᴇᴅ ʙʏ:** [PʀᴏBᴏᴛs](https://t.me/DUNE_BOTS)
┗━━━━━━━━━━━━━━━━━⧫
...
async def start(_, msg):
    buttons = [
        [
                InlineKeyboardButton("𝗦𝗨𝗣𝗣𝗢𝗥𝗧", url="https://t.me/DUNEBOTS"),
                InlineKeyboardButton("𝗨𝗣𝗗𝗔𝗧𝗘", url="https://t.me/DUNE_BOTS")
        ],
        [ 
...
async def repo(_, message):
    ...
    if response.status_code == 200:
        ...
        text = f"""[𝖱𝖤𝖯𝖮 𝖫𝖨𝖭𝖪](https://t.me/DUNE_BOTS) | [𝖦𝖱𝖮𝖴𝖯](https://t.me/DUNEBOTS)
| 𝖢𝖮𝖭𝖳𝖱𝖨𝖡𝖴𝖳𝖮𝖱𝖲 |
----------------
{list_of_users}"""
